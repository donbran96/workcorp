...
<body>
    <header class="fixed-top">
        <div class="contenedor padding-vertical">
            <div class="fila-1 d-flex justify-content-between align-items-center flex-column flex-sm-row">
        ...
        <!--<div class="fila-2 d-flex flex-column flex-lg-row">
                ...
                <div class="menu d-flex flex-grow-1 align-items-center mt-3 mt-lg-0">
                    <ul class="d-flex justify-content-center flex-grow-1 mb-0 px-0 flex-wrap">
